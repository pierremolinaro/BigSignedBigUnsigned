...
static const char * ChunkUIntDecimalFormatSpecifierWithLeadingZeros __attribute__ ((unused)) = "%02" PRIu8 ;
static const char * ChunkUIntHexFormatSpecifierWithLeadingZeros __attribute__ ((unused)) = "%02" PRIX8 ;

//--------------------------------------------------------------------------------------------------

inline uint32_t countLeadingZeros (const ChunkUInt inValue) {
  return uint32_t (__builtin_clzl (inValue) - 56) ;
}
