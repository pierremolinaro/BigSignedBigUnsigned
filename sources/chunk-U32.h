...
static const char * ChunkUIntDecimalFormatSpecifierWithLeadingZeros __attribute__ ((unused)) = "%09" PRIu32 ;
static const char * ChunkUIntHexFormatSpecifierWithLeadingZeros __attribute__ ((unused)) = "%09" PRIX32 ;

//--------------------------------------------------------------------------------------------------

inline uint32_t countLeadingZeros (const ChunkUInt inValue) {
  return uint32_t (__builtin_clz (inValue)) ;
}
